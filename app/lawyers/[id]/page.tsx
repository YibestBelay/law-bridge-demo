...
const mockLawyer = {
  ...
  education: [
    { degree: 'Law Degree', institution: 'Addis Ababa University', year: '2011' },
    { degree: 'Bar License', institution: 'Ethiopian Bar Association', year: '2012' },
    { degree: 'Continuing Education Certificate', institution: 'Ethiopian Legal Institute', year: '2024' }
  ],
  ...
  notableCases: [
    {
      ...
      description: 'Successfully defended client in complex fraud case involving multiple parties and jurisdictions.',
      outcome: 'Won',
      year: '2023'
    },
    {
      type: 'Appeals',
      description: 'Overturned lower court decision in high-profile case, securing client\'s release.',
      outcome: 'Won',
      year: '2022'
    },
    {
      type: 'Criminal Defense',
      description: 'Negotiated favorable settlement in white-collar crime case, avoiding trial.',
      outcome: 'Settled',
      year: '2023'
    }
  ],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 lg:pb-8">
        <div className="flex gap-8">
          ...
          <main className="flex-1 lg:w-2/3 space-y-8">
            ...
            <SpecializationsSection areasOfPractice={mockLawyer.areasOfPractice} />
            <EducationSection
